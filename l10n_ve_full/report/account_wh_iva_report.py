...
class IvaReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if data['form'].state == 'done':
            if data['form'].wh_lines.invoice_id.currency_id.id == data['form'].company_id.currency_id.id :
            ...
            elif data['form'].wh_lines.invoice_id.currency_id != data['form'].company_id.currency_id:
                ...
                if module_dual_currency:
                    total_doc = data['form'].wh_lines.invoice_id.amount_total * data['form'].wh_lines.invoice_id.tax_today
                else:
                    tasa = data['form'].wh_lines.invoice_id.currency_id.inverse_rate
    ...
    def get_period(self, date):
        if not date:
            raise UserError (_("You need date."))
