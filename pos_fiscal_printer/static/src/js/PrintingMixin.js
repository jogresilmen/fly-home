...
export class PrintingMixin {
    ...
    //             return true;
    //         } else {
    //             // Verifica si el puerto ya está abierto antes de intentar abrirlo de nuevo
    ...
    async write() {
        ...
        console.log(this.printerCommands,"<<<<<<<<<<<<<<<<<<<<<<<<<<<<<")
    ...
    async printViaApi() {
        ...
        await jsonrpc(url, 'call', body).then((response) => {
             this.modal_imprimiendo.close();
