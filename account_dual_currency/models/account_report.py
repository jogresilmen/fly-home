...
class AccountReport(models.AbstractModel):
    ...
    filter_currency_dif = fields.Boolean(
        string="Cash Basis",
        compute=lambda x: x._compute_report_option_filter('filter_currency_dif', False), readonly=False, store=True, depends=['root_report_id'],
    ...
    def get_report_information(self, options):
        ...
        info['filters']['show_currency_dif'] = self.filter_currency_dif
        return info

    def _init_options_cash_basis(self, options, previous_options=None):
        if self.filter_currency_dif:
            options['report_currency_dif'] = (previous_options or {}).get('report_currency_dif', False)
    ...
    def get_options(self, previous_options=None):
        super().get_options(previous_options=previous_options)
        #self.ensure_one()
